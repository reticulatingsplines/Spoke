    ...
    return (
      <div>
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          if (!currentExportJob) {
                            ...
                            await this.props.mutations.deleteJob(
                              currentExportJob.id
                            );
                          }
                        }}
        ...
        {campaign.exportResults ? (
          <div>
            ...
            campaign.exportResults.campaignExportUrl.startsWith("http") ? (
              <div>
                Most recent campaign data export{" "}
                {campaign.exportResults.createdAt ? (
                  <span>generated at {campaign.exportResults.createdAt}.</span>
                ) : (
                  <span> - note timestamp in file names below.</span>
                )}
                <br />
                <b>Files available on the server (click to download):</b>
                <br />
              ...
              <div>
                Most recent campaign data export{" "}
                {campaign.exportResults.createdAt
                  ? `generated on ${campaign.exportResults.createdAt}.`
                  : `- note timestamp in file names below.`}
                <br />
                <b>Files saved on the server (click to download):</b>
                <br />
                <br />
          ...
          <div>No exported data currently cached.</div>
        )}
        ...
        <Snackbar
          ...
          message={
            <span>
              Export started. This page will automatically refresh in 10 seconds
              to display download links. Otherwise,{" "}
          ...
          autoHideDuration={campaign.cacheable ? null : 10000}
          onClose={() => {
...
const mutations = {
  ...
  deleteJob: ownProps => exportJobId => ({
    mutation: gql`
