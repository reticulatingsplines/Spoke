...
export class UserEditBase extends React.Component {
  static propTypes = {
    ...
    adminPeopleEdit: PropTypes.bool
  };
  ...
  handleSave = async formData => {
    const editSuccessAlert = () => {
      this.setState({ editSuccessToast: true });
    };
    ...
    if (!this.props.authType) {
      ...
      const usersav = await this.props.mutations.editUser(formData);
      if (usersav.errors) {
  ...
  render() {
    ...
    return (
      <div style={{ padding: 20 }}>
        {userId ? (
          <div style={{}}>
            Your Spoke User ID Number: {userId}
            <br></br>
            <Box sx={{ width: "100%" }}>
              <Alert variant="filled" severity="info">
                Please confirm your user information below is accurate and
        ...
        <div>
          <Snackbar
            ...
            open={this.state.editSuccessToast}
