...
const PasswordResetLink = ({ passwordResetHash }) => {
  ...
  const textContent =
    "Send your texting volunteer this link! Once they try to log in, they'll be asked to create a new password. Please note that the link expires in 24 hours, after which a new link will need to be generated.";
